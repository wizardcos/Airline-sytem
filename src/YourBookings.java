	...
	public YourBookings() 
	{
		...
		btnRemove.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
				...
				{
					new JOptionPane();
					JOptionPane.showMessageDialog(panel,"Please Select only One Row!!","Error",JOptionPane.INFORMATION_MESSAGE);
				}
				...
				else if (table.getSelectedRow()!=-1)
				{
					...
					new JOptionPane();
					JOptionPane.showMessageDialog(panel,"Cancelled but you will be charged penalty! "+penalty,"Flight Removed",JOptionPane.INFORMATION_MESSAGE);
				
				}
				else if (table.getSelectedRow()==-1)
				{
					new JOptionPane();
					JOptionPane.showMessageDialog(panel,"Please Select any Row!!","Error",JOptionPane.INFORMATION_MESSAGE);
				}
		...
		btnBill.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
				...
				if (table.getSelectedRow()==-1)
				{
					...
					new JOptionPane();
					JOptionPane.showMessageDialog(panel,"Your total of all flights with Tax is : "+product,"Bill",JOptionPane.INFORMATION_MESSAGE);	
				}
				
				else if (table.getSelectedRowCount()>1)
				{
					new JOptionPane();
					JOptionPane.showMessageDialog(panel,"Please Select One Flight to view its Bill details ","Error",JOptionPane.INFORMATION_MESSAGE);	
				}
				...
				new JOptionPane();
				JOptionPane.showMessageDialog(panel,"Your Bill of this Flights with Tax is : "+total,"Bill",JOptionPane.INFORMATION_MESSAGE);
