...
public class BookingFrame extends JFrame
{
	...
	public BookingFrame(Passenger object)
	{
		...
		label = new JLabel("Schedule of NPAFS Flights");
		panel2.add(label);
		label.setFont(new Font("Tahoma", Font.BOLD, 18));
		
		labeltag = new JLabel("NPAFS Flight Schedule on 28 Dec 2021");
		...
		btnBook.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
				...
				{
					new JOptionPane();
					JOptionPane.showMessageDialog(panel,"Please Select only One flight!!","Error",JOptionPane.INFORMATION_MESSAGE);
				}
						...
						if (tempObject.getSeatsEconomy()>0)
						{
							...
							if (validSeats(str)==true)
							{
							  ...
							  if (seatsBooked!=0)
							  {
									...
									if (tempObject.getFlightId().contains("Int")||tempObject.getFlightId().contains("INT"))
									{
										...
										if(s.equals("yes")||s.equals("Yes")||s.equals("y")||s.equals("Y")|| s.equals("YES"))
										{
												...
												BookingObject obj = new BookingObject(tempObject.getFlightId(),tempObject.getDepartureAirport(),
													...
													new JOptionPane();
													JOptionPane.showMessageDialog(panel,"Successfully Booked","Successful",JOptionPane.INFORMATION_MESSAGE);
													dispose();
										...
										{
											new JOptionPane();
											JOptionPane.showMessageDialog(panel,"Can not Book because you dont have passport!!","Failed",JOptionPane.INFORMATION_MESSAGE);
										}
									}
									else
									{
								...
								{
									new JOptionPane();
									JOptionPane.showMessageDialog(panel,"Not Enough Available Seats!","Failed",JOptionPane.INFORMATION_MESSAGE);
								}
							  }
							 else
							 {
										new JOptionPane();
											JOptionPane.showMessageDialog(panel,"Enter Atleast One Seat!","Failed",JOptionPane.INFORMATION_MESSAGE);
							  }
							}
							else
							{
								new JOptionPane();
								JOptionPane.showMessageDialog(panel,"Invalid Input for seats","Error",JOptionPane.INFORMATION_MESSAGE);
							}
						}
						else
						{
							new JOptionPane();
							JOptionPane.showMessageDialog(panel,"No Available Seats in Selected Class! Booking Failed","Not Booked",JOptionPane.INFORMATION_MESSAGE);
						}
					...
					{	
						if (tempObject.getSeatsBusiness()>0)
						{
							...
							if (seatsBooked!=0)
							{
							  ...
							  {
								  new JOptionPane();
									JOptionPane.showMessageDialog(panel,"Select atleast one seat!!","Failed",JOptionPane.INFORMATION_MESSAGE);
							  }
							}
							else
							{
				...
				{
					new JOptionPane();
					JOptionPane.showMessageDialog(panel,"Please Select any Flight first!!","Error",JOptionPane.INFORMATION_MESSAGE);
				}
