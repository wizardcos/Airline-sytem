	...
	public LogInScreen() {
		...
		button.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
				...
				if (field1.getText().equals("") || new String(field2.getPassword()).equals("")) {
					...
					for (Passenger obj : MainMenu.listPassenger) {
						if (field1.getText().equals(obj.getUsername())
								&& new String(field2.getPassword()).equals(obj.getPassword())) {
							check = true;
							index = counter;
							break;
						}
