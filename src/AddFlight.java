					 ...
					 if (fieldflightId.getText().contains("INT") || fieldflightId.getText().contains("Int") || fieldflightId.getText().contains("Dom") || fieldflightId.getText().contains("DOM") )
					  {
								...
								if ((eco>=0 && eco<=50) && (business>=0 && business<=10))
								{
									if(validFlight())
									{
										...
										MainMenu.listFlights.add(object);
											...
											new JOptionPane();
											JOptionPane.showMessageDialog(panel,"Successfully Added","Successful",JOptionPane.INFORMATION_MESSAGE);	
									}
									else
									{
										new JOptionPane();
						  ...
						  {
							  new JOptionPane();
								JOptionPane.showMessageDialog(panel,"Invalid Input for flight Id!","Error",JOptionPane.INFORMATION_MESSAGE);
						  }
						}
				else
				{
