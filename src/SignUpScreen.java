...
public class SignUpScreen
{
    ...
    !new String(confirmpass.getPassword()).equals("") && 
    !fieldcnic1.getText().equals("") && 
    !fieldcnic2.getText().equals("") && 
    !fieldcnic3.getText().equals("")) {
    boolean accountexists = false;

    for (Passenger object : MainMenu.listPassenger) {
        if (fieldusername.getText().equals(object.getUsername()) || 
            fieldemail.getText().equals(object.getEmail()) || 
            cnic.equals(object.getCnic()) || 
            new String(pass.getPassword()).equals(object.getPassword())) {
            accountexists = true;
            break;
        }
    }
    ...
    if (!accountexists) {
        if (fieldusername.getText().length() >= 6) {
            if (validEmail(fieldemail.getText())) {
                if (validCNIC(fieldcnic1.getText()) && 
                    validCNIC(fieldcnic2.getText()) && 
                    validCNIC(fieldcnic3.getText()) && 
                    cnic.length() == 13) {
                    if (validPassword(new String(pass.getPassword())) && 
                        new String(pass.getPassword()).length() >= 8) {
                        if (new String(pass.getPassword()).equals(new String(confirmpass.getPassword()))) {
                            ...
                            Passenger obj = new Passenger(fieldusername.getText(), 
                                fieldemail.getText(), cnic, new String(pass.getPassword()));
                        ...
                        l.setText("*Password must have at least 8 characters");
            ...
            l.setText("*Username must have at least 6 characters");
            l2.setText(null);
            l3.setText(null);
        }
    } else {
        ...
        JOptionPane.showMessageDialog(panel, 
            "Signup Failed: The attributes you entered are already occupied", 
