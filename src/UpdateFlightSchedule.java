	...
	public UpdateFlightSchedule() 
	{
		...
		btnRemove.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
				...
				{
					new JOptionPane();
					JOptionPane.showMessageDialog(panel,"Please Select only One Row!!","",JOptionPane.INFORMATION_MESSAGE);
				}
				...
				{
					new JOptionPane();
					JOptionPane.showMessageDialog(panel,"Please Select any Row!!","",JOptionPane.INFORMATION_MESSAGE);
				}
